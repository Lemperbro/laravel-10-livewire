...
<div class="">
    ...
    @endif
    <input
        {{ $attributes->merge(['type' => 'email', 'id' => 'email', 'class' => 'py-3 px-4 block w-full border-border-1 rounded-lg text-sm focus:border-accent-600 focus:ring-0 disabled:opacity-50 disabled:pointer-events-none dark:bg-dark-2 dark:border-borderDark-1 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:border-borderDark-2', 'placeholder' => 'you@gmail.com']) }}>
    @if ($helper_text !== null)
